<template>
    ...
    <div id="connect" class="ff-1" style="font-weight: bolder;
        margin-left: -0.5rem;">
        <span style="color: brown; font-size: 18px; font-family: Satisfy;">Connect with me</span>  
